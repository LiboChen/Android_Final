...
import com.aptPhase3.zhiyuan.android.R.string;
/**
...
//        builder.setView(inflater.inflate(R.layout.fragment_poi, null))
//                // Add action buttons
//                .setPositiveButton(R.id.buttonOk, new DialogInterface.OnClickListener() {
//                    @Override
